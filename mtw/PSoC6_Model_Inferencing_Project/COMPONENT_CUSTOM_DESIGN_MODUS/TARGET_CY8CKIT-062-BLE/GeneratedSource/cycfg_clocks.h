...
#define EZI2C_CLK_DIV_ENABLED 1U
#define EZI2C_CLK_DIV_HW CY_SYSCLK_DIV_8_BIT
#define EZI2C_CLK_DIV_NUM 1U

#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t CYBSP_CSD_CLK_DIV_obj;
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t EZI2C_CLK_DIV_obj;
#endif //defined (CY_USING_HAL)
