...
#define CYBSP_D15_ENABLED CYBSP_I2C_SCL_ENABLED
#define CYBSP_I2C_SCL_PORT GPIO_PRT6
#define CYBSP_D15_PORT CYBSP_I2C_SCL_PORT
#define CYBSP_I2C_SCL_PORT_NUM 6U
#define CYBSP_D15_PORT_NUM CYBSP_I2C_SCL_PORT_NUM
#define CYBSP_I2C_SCL_PIN 0U
#define CYBSP_D15_PIN CYBSP_I2C_SCL_PIN
#define CYBSP_I2C_SCL_NUM 0U
#define CYBSP_D15_NUM CYBSP_I2C_SCL_NUM
#define CYBSP_I2C_SCL_DRIVEMODE CY_GPIO_DM_OD_DRIVESLOW
#define CYBSP_D15_DRIVEMODE CYBSP_I2C_SCL_DRIVEMODE
#define CYBSP_I2C_SCL_INIT_DRIVESTATE 1
#define CYBSP_D15_INIT_DRIVESTATE CYBSP_I2C_SCL_INIT_DRIVESTATE
...
#define CYBSP_D15_HSIOM CYBSP_I2C_SCL_HSIOM
#define CYBSP_I2C_SCL_IRQ ioss_interrupts_gpio_6_IRQn
#define CYBSP_D15_IRQ CYBSP_I2C_SCL_IRQ
#if defined (CY_USING_HAL)
	#define CYBSP_I2C_SCL_HAL_PORT_PIN P6_0
	#define CYBSP_D15_HAL_PORT_PIN CYBSP_I2C_SCL_HAL_PORT_PIN
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	...
	#define CYBSP_D15_HAL_IRQ CYBSP_I2C_SCL_HAL_IRQ
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define CYBSP_I2C_SCL_HAL_DIR CYHAL_GPIO_DIR_BIDIRECTIONAL 
	#define CYBSP_D15_HAL_DIR CYBSP_I2C_SCL_HAL_DIR
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define CYBSP_I2C_SCL_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_OPENDRAINDRIVESLOW
	#define CYBSP_D15_HAL_DRIVEMODE CYBSP_I2C_SCL_HAL_DRIVEMODE
#endif //defined (CY_USING_HAL)
#define CYBSP_I2C_SDA_ENABLED 1U
#define CYBSP_D14_ENABLED CYBSP_I2C_SDA_ENABLED
#define CYBSP_I2C_SDA_PORT GPIO_PRT6
#define CYBSP_D14_PORT CYBSP_I2C_SDA_PORT
#define CYBSP_I2C_SDA_PORT_NUM 6U
#define CYBSP_D14_PORT_NUM CYBSP_I2C_SDA_PORT_NUM
#define CYBSP_I2C_SDA_PIN 1U
#define CYBSP_D14_PIN CYBSP_I2C_SDA_PIN
#define CYBSP_I2C_SDA_NUM 1U
#define CYBSP_D14_NUM CYBSP_I2C_SDA_NUM
#define CYBSP_I2C_SDA_DRIVEMODE CY_GPIO_DM_OD_DRIVESLOW
#define CYBSP_D14_DRIVEMODE CYBSP_I2C_SDA_DRIVEMODE
#define CYBSP_I2C_SDA_INIT_DRIVESTATE 1
#define CYBSP_D14_INIT_DRIVESTATE CYBSP_I2C_SDA_INIT_DRIVESTATE
...
#define CYBSP_D14_HSIOM CYBSP_I2C_SDA_HSIOM
#define CYBSP_I2C_SDA_IRQ ioss_interrupts_gpio_6_IRQn
#define CYBSP_D14_IRQ CYBSP_I2C_SDA_IRQ
#if defined (CY_USING_HAL)
	#define CYBSP_I2C_SDA_HAL_PORT_PIN P6_1
	#define CYBSP_D14_HAL_PORT_PIN CYBSP_I2C_SDA_HAL_PORT_PIN
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	...
	#define CYBSP_D14_HAL_IRQ CYBSP_I2C_SDA_HAL_IRQ
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define CYBSP_I2C_SDA_HAL_DIR CYHAL_GPIO_DIR_BIDIRECTIONAL 
	#define CYBSP_D14_HAL_DIR CYBSP_I2C_SDA_HAL_DIR
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define CYBSP_I2C_SDA_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_OPENDRAINDRIVESLOW
	#define CYBSP_D14_HAL_DRIVEMODE CYBSP_I2C_SDA_HAL_DRIVEMODE
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
...
#define CYBSP_D15_config CYBSP_I2C_SCL_config
#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t CYBSP_I2C_SCL_obj;
	#define CYBSP_D15_obj CYBSP_I2C_SCL_obj
#endif //defined (CY_USING_HAL)
extern const cy_stc_gpio_pin_config_t CYBSP_I2C_SDA_config;
#define CYBSP_D14_config CYBSP_I2C_SDA_config
#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t CYBSP_I2C_SDA_obj;
	#define CYBSP_D14_obj CYBSP_I2C_SDA_obj
#endif //defined (CY_USING_HAL)
